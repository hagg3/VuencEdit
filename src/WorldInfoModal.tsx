...
const keyStyle: React.CSSProperties = { color: "#afa69d", flexShrink: 0 };
const valStyle: React.CSSProperties = { color: "#ebe9e7", textAlign: "right", wordBreak: "break-all" };
...
export default function WorldInfoModal({ onClose }: { onClose: () => void }) {
  ...
  const modal: React.CSSProperties = glassPanel({
    ...
    overflowY: "auto", color: "#ebe9e7", fontFamily: "monospace", fontSize: 12,
  });
        ...
        {info && <>
          ...
          <div style={section}>
            ...
            {info.spawn_px != null
              ...
              : <Row k="Spawn" v={<span style={{ color: "#61584f" }}>not set</span>} />}
